...
staticDim = 13; % How many static points there are on each side (Top, Bottom, Left and Right) in one set
staticLen = 27; % How many sets of static points there are along the traj
staticRes = 2; % How far apart the static points are on each side
